...
try:
    ...
    write_to_file = False
    print "\nWARNING: Write folder NOT provided: Results will not be saved but still be printed onto the terminal window. If you want to save the analysis results to textfiles you must provide a destination folder as FIRST argument."
try:
    infolder = sys.argv[2]
